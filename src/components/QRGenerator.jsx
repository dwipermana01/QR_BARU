...
const QRGenerator = () => {
  ...
  const baseUrl = 'qr-baru.vercel.app'; // Ganti dengan domain Anda
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {Object.entries(qrCodes).map(([roomId, qrDataUrl]) => (
              <div 
                key={roomId}
                className="bg-gray-50 p-6 rounded-2xl border-2 border-gray-200 hover:border-blue-500 transition-all duration-300 hover:shadow-lg text-center"
              >
