export const roomsData = {
  ...
  "030201": {
    ...
    legendItems: [
      ...
      { number: 17, name: "Papan Data Informasi", color: "#FF9188" },
  ...
  "030202": {
    ...
    legendItems: [
      ...
      { number: 2, name: "Meja Siswa", color: "#8AA3FF" },
      ...
      { number: 8, name: "Proyektor", color: "#FF7878" },
      { number: 9, name: "Layar Proyektor", color: "#FED2E3" },
      { number: 10, name: "Papan Tulis", color: "#641B2E", textColor: "#FFFFFF" },
      { number: 11, name: "IP Camera", color: "#FDFF84" },
      { number: 12, name: "Loker", color: "#C2C2C2" },
      { number: 13, name: "Jam Dinding", color: "#2B9DF5", textColor: "#FFFFFF" },
      { number: 14, name: "Lemari", color: "#E08A13", textColor: "#FFFFFF" },
      { number: 15, name: "Salib", color: "#827F88" },
      { number: 16, name: "Bendera", color: "#892D3A", textColor: "#FFFFFF" },
      { number: 17, name: "Lambang Garuda", color: "#B55E55" },
      { number: 18, name: "Bingkai Presiden dan Wakil Presiden", color: "#B55E55" },
      { number: 19, name: "Papan Data Informasi", color: "#FF9188" },
