export const roomsData = {
  ...
  "030205": {
    ...
    assets: [
      { icon: "/icons/table.svg", name: "Meja Siswa", count: "27 Unit" },
      { icon: "/icons/studentChair.svg", name: "Kursi Siswa", count: "24 Unit" },
      { icon: "/icons/teacherDesk.svg", name: "Meja Guru", count: "1 Unit" },
      { icon: "/icons/teacherChair.svg", name: "Kursi Guru", count: "1 Unit" },
      { icon: "/icons/speaker.svg", name: "Speaker", count: "2 Unit" },
  ...
  "030302": {
    ...
    assets: [
      { icon: "/icons/table.svg", name: "Meja Siswa", count: "32 Unit" },
      { icon: "/icons/studentChair.svg", name: "Kursi Siswa", count: "28 Unit" },
      { icon: "/icons/teacherDesk.svg", name: "Meja Guru", count: "1 Unit" },
      { icon: "/icons/teacherChair.svg", name: "Kursi Guru", count: "1 Unit" },
      { icon: "/icons/speaker.svg", name: "Speaker", count: "2 Unit" },
      { icon: "/icons/airConditioner.svg", name: "Air Conditioner", count: "2 Unit" },
      ...
      { icon: "/icons/whiteboardFrame.svg", name: "Papan Tulis", count: "2 Unit" },
      { icon: "/icons/lockers.svg", name: "Loker", count: "2 Unit" },
      { icon: "/icons/p3k.svg", name: "P3K", count: "1 Unit" },
   ...
   "030303": {
    ...
    assets: [
      { icon: "/icons/table.svg", name: "Meja", count: "2 Unit" },
      { icon: "/icons/studentChair.svg", name: "Kursi Siswa", count: "1 Unit" },
      { icon: "/icons/cabinet.svg", name: "Lemari", count: "2 Unit" },
      { icon: "/icons/water-dispenser.svg", name: "Dispenser", count: "1 Unit" }
    ],
   ...
   "030304": {
    ...
    assets: [
      ...
      { icon: "/icons/trash.svg", name: "Tempat Sampah", count: "1 Unit" },
      { icon: "/icons/cabinet.svg", name: "Loker", count: "1 Unit" },
      { icon: "/icons/mirror.svg", name: "Cermin", count: "1 Unit" },
      { icon: "/icons/water-dispenser.svg", name: "Dispenser", count: "1 Unit" },
   ...
   "030305": {
    ...
    assets: [
      ...
      { icon: "/icons/patung.svg", name: "Patung Buda Maria", count: "1 Unit" },
      { icon: "/icons/stopcontact.svg", name: "Stopcontact", count: "1 Unit" },
      { icon: "/icons/cross.svg", name: "Salib", count: "2 Unit" },
      { icon: "/icons/ladder.svg", name: "Tangga Ranjang UKS", count: "2 Unit" },
      { icon: "/icons/fan.svg", name: "Kipas Angin", count: "1 Unit" },
   ...
   "030306": {
    ...
    assets: [
      ...
      { icon: "/icons/chair-chitose.svg", name: "Kursi", count: "7 Unit" },
      { icon: "/icons/rice-cooker.svg", name: "Rice Cooker", count: "1 Unit" },
      { icon: "/icons/water-dispenser.svg", name: "Dispenser", count: "1 Unit" },
      { icon: "/icons/rak-piring.svg", name: "Rak Piring", count: "1 Unit" },
      { icon: "/icons/kompor.svg", name: "Kompor Gas", count: "1 Unit" },
      { icon: "/icons/tabung-gas.svg", name: "Tabung Gas", count: "2 Unit" },
      { icon: "/icons/microwave.svg", name: "Microwave", count: "1 Unit" },
      { icon: "/icons/water-purifier.svg", name: "Water Purifier", count: "1 Unit" },
      { icon: "/icons/wastafel.svg", name: "Wastafel", count: "1 Unit" },
      { icon: "/icons/lemari-gantung.svg", name: "Lemari Gantung", count: "1 Unit" },
   ...
   "030307": {
    ...
    assets: [
      ...
      { icon: "/icons/teacherDesk.svg", name: "Meja", count: "34 Unit" },
      { icon: "/icons/cabinet.svg", name: "Lemari", count: "8 Unit" },
      { icon: "/icons/speaker.svg", name: "Speaker", count: "1 Unit" },
      { icon: "/icons/airConditioner.svg", name: "Air Conditioner", count: "2 Unit" },
      { icon: "/icons/whiteboardFrame.svg", name: "Papan Tulis", count: "2 Unit" },
      { icon: "/icons/lockers.svg", name: "Laci", count: "7 Unit" },
      { icon: "/icons/clock.svg", name: "Jam Dinding", count: "1 Unit" },
      { icon: "/icons/fan.svg", name: "Kipas Angin", count: "2 Unit" },
      { icon: "/icons/nursecall.svg", name: "Telfon", count: "1 Unit" },
      { icon: "/icons/tv.svg", name: "TV", count: "2 Unit" },
      { icon: "/icons/whiteboardFrame.svg", name: "Papan Tulis", count: "2 Unit" },
      { icon: "/icons/fotocopy.svg", name: "Printer", count: "2 Unit" },
      { icon: "/icons/stopcontact.svg", name: "Stopcontact", count: "20 Unit" },
      { icon: "/icons/flag.svg", name: "Bendera", count: "1 Set" },
      { icon: "/icons/garudaPancasila.svg", name: "Lambang Garuda", count: "1 Unit" },
      { icon: "/icons/frame.svg", name: "Bingkai", count: "2 Unit" },
      { icon: "/icons/hangingWhiteboard.svg", name: "Papan Data Informasi", count: "1 Unit" }
  ...
  "030308": {
    ...
    assets: [
      ...
      { icon: "/icons/bed-uks.svg", name: "Kasur UKS", count: "1 Unit" },
      { icon: "/icons/trash.svg", name: "Tempat Sampah", count: "1 Unit" },
      { icon: "/icons/scales-body.svg", name: "Timbangan Badan", count: "1 Unit" },
      { icon: "/icons/ladder.svg", name: "Tangga Ranjang UKS", count: "1 Unit" },
      { icon: "/icons/fan.svg", name: "Kipas Angin", count: "1 Unit" },
      { icon: "/icons/garudaPancasila.svg", name: "Lambang Garuda", count: "1 Unit" },
      { icon: "/icons/frame.svg", name: "Bingkai", count: "2 Unit" },
      { icon: "/icons/hangingWhiteboard.svg", name: "Papan Data Informasi", count: "1 Unit" }
  ...
  "030401": {
    ...
    assets: [
      ...
      { icon: "/icons/studentChair.svg", name: "Kursi", count: "14 Unit" },
      { icon: "/icons/speaker.svg", name: "Speaker", count: "2 Unit" },
      { icon: "/icons/airConditioner.svg", name: "Air Conditioner", count: "2 Unit" },
      { icon: "/icons/projector.svg", name: "Proyektor", count: "1 Unit" },
      { icon: "/icons/projectorScreen.svg", name: "Screen Proyektor", count: "1 Unit" },
      { icon: "/icons/whiteboardFrame.svg", name: "Papan Tulis", count: "2 Unit" },
      { icon: "/icons/lockers.svg", name: "Loker", count: "2 Unit" },
      { icon: "/icons/kursi-plastik.svg", name: "Kursi Plastik", count: "1 Unit" },
      { icon: "/icons/clock.svg", name: "Jam Dinding", count: "1 Unit" },
  ...
  "030404": {
    ...
    assets: [
      ...
      { icon: "/icons/studentChair.svg", name: "Kursi Siswa", count: "29 Unit" },
      { icon: "/icons/teacherDesk.svg", name: "Meja Guru", count: "1 Unit" },
      { icon: "/icons/teacherChair.svg", name: "Kursi Guru", count: "2 Unit" },
      { icon: "/icons/speaker.svg", name: "Speaker", count: "2 Unit" },
      { icon: "/icons/airConditioner.svg", name: "Air Conditioner", count: "2 Unit" },
      { icon: "/icons/projector.svg", name: "Proyektor", count: "1 Unit" },
      { icon: "/icons/projectorScreen.svg", name: "Screen Proyektor", count: "1 Unit" },
      ...
      { icon: "/icons/frame.svg", name: "Bingkai", count: "2 Unit" },
      { icon: "/icons/hangingWhiteboard.svg", name: "Papan Data Informasi", count: "1 Unit" },
      { icon: "/icons/bass.svg", name: "Bass Guitar", count: "1 Unit" },
