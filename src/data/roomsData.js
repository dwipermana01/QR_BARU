export const roomsData = {
  ...
  "030404": {
    ...
    legendItems: [
      ...
      { number: 3, name: "Kursi", color: "#FE0000", textColor: "#FFFFFF" },
      { number: 4, name: "Kipas Angin", color: "#346AF1", textColor: "#FFFFFF" },
      { number: 5, name: "Air Conditioner", color: "#E9ECFF" },
      { number: 6, name: "Projector", color: "#FF7878", textColor: "#FFFFFF" },
      { number: 7, name: "Layar Proyektor", color: "#FED2E3" },
      ...
      { number: 14, name: "Papan Data Informasi", color: "#BD5B50", textColor: "#FFFFFF" },
      { number: 15, name: "Jendela", color: "#ffffff" },
      { number: 16, name: "Standing Wooden Easel", color: "#B4721B", textColor: "#FFFFFF" },
      { number: 17, name: "Meja Guru", color: "#8AA3FF", textColor: "#FFFFFF" },
      { number: 18, name: "Kursi Guru", color: "#FE0000", textColor: "#FFFFFF" },
      { number: 19, name: "Speaker", color: "#0C0950", textColor: "#FFFFFF" },
    ]
  },
